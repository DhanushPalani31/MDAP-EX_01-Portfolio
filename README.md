...
<head>
  ...
  <title>Dhanush P — Frontend Developer</title>
  <meta name="description" content="Dhanush P — Frontend Developer (Portfolio & Resume)" />
  <style>
    :root{
      --bg:#0f1724;
      --card:#0b1220;
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      background:
        ...
        radial-gradient(600px 300px at 90% 90%, rgba(6,182,212,0.06), transparent 10%),
        var(--bg);
      color:#e6eef6;
  ...
  <div class="wrap" role="main" aria-label="Portfolio of Dhanush P">
    ...
    <aside class="sidebar" aria-labelledby="about-heading">
      ...
      <div>
        ...
        <div class="contact" aria-label="Contact and links">
